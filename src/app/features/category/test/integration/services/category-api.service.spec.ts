...
describe('CategoryApiService', () => {
  ...
  it('requests a paginated category list', () => {
    categoryApiService.list(2, 10).subscribe();

    const request = httpTestingController.expectOne('/api/categories?page=2&size=10');
